...
// ===== 核心规范固定参数库（按等级取值，准确可靠） =====
var SPEC_PARAMS = {
  'JTG B01-2014': {
    高速:{'设计速度(km/h)':'120','车道宽度(m)':'3.75','车道数':'≥4','硬路肩宽(m)':'3.00~3.50','中间带宽(m)':'4.50/3.50','路基宽度(m)':'26~44','停车视距(m)':'210','最大纵坡(%)':'3','最大超高(%)':'8','建筑限界净高(m)':'5.00','路面设计年限':'15','汽车荷载':'公路-Ⅰ级','设计洪水频率':'1/100'},
    一级:{'设计速度(km/h)':'100','车道宽度(m)':'3.75','车道数':'≥4','硬路肩宽(m)':'2.50~3.00','中间带宽(m)':'3.50/3.00','路基宽度(m)':'24~33','停车视距(m)':'160','最大纵坡(%)':'4','最大超高(%)':'8','建筑限界净高(m)':'5.00','路面设计年限':'15','汽车荷载':'公路-Ⅰ级','设计洪水频率':'1/100'},
    二级:{'设计速度(km/h)':'80','车道宽度(m)':'3.75','车道数':'2','硬路肩宽(m)':'1.50~2.50','路基宽度(m)':'10~12','停车视距(m)':'110','最大纵坡(%)':'5','最大超高(%)':'8','建筑限界净高(m)':'5.00','路面设计年限':'12','汽车荷载':'公路-Ⅰ/Ⅱ级','设计洪水频率':'1/50'},
    三级:{'设计速度(km/h)':'40','车道宽度(m)':'3.50','车道数':'2','路基宽度(m)':'8.50','停车视距(m)':'40','最大纵坡(%)':'7','最大超高(%)':'6','建筑限界净高(m)':'4.50','路面设计年限':'8','汽车荷载':'公路-Ⅱ级','设计洪水频率':'1/25'},
    四级:{'设计速度(km/h)':'30','车道宽度(m)':'3.25','车道数':'2/1','路基宽度(m)':'6.50/4.50','停车视距(m)':'30','最大纵坡(%)':'8','最大超高(%)':'4','建筑限界净高(m)':'4.50','路面设计年限':'6','汽车荷载':'公路-Ⅱ级','设计洪水频率':'按具体情况'},
  },
  'JTG D20-2017': {
    高速:{'平曲线一般半径(m)':'1000','平曲线极限半径(m)':'650','缓和曲线最小长(m)':'100','最大纵坡(%)':'3','最大坡长(m)':'900','停车视距(m)':'210','会车视距(m)':'420','超车视距(m)':'550'},
    一级:{'平曲线一般半径(m)':'700','平曲线极限半径(m)':'400','缓和曲线最小长(m)':'85','最大纵坡(%)':'4','最大坡长(m)':'800','停车视距(m)':'160','会车视距(m)':'320','超车视距(m)':'440'},
    二级:{'平曲线一般半径(m)':'400','平曲线极限半径(m)':'250','缓和曲线最小长(m)':'70','最大纵坡(%)':'5','最大坡长(m)':'700','停车视距(m)':'110','会车视距(m)':'220'},
    三级:{'平曲线一般半径(m)':'100','平曲线极限半径(m)':'60','缓和曲线最小长(m)':'35','最大纵坡(%)':'7','最大坡长(m)':'500','停车视距(m)':'40','会车视距(m)':'80'},
    四级:{'平曲线一般半径(m)':'65','平曲线极限半径(m)':'30','缓和曲线最小长(m)':'25','最大纵坡(%)':'8','最大坡长(m)':'300','停车视距(m)':'30','会车视距(m)':'60'},
  },
  'JTG D30-2015': {
    高速:{'上路床压实度(%)':'≥96','下路床压实度(%)':'≥96','上路堤压实度(%)':'≥94','下路堤压实度(%)':'≥93','上路床CBR(%)':'≥8','下路床CBR(%)':'≥5','抗滑稳定Kc':'≥1.3','抗倾覆K₀':'≥1.5'},
    一级:{'上路床压实度(%)':'≥96','下路床压实度(%)':'≥96','上路堤压实度(%)':'≥94','下路堤压实度(%)':'≥93','上路床CBR(%)':'≥8','下路床CBR(%)':'≥5','抗滑稳定Kc':'≥1.3','抗倾覆K₀':'≥1.5'},
    二级:{'上路床压实度(%)':'≥95','下路床压实度(%)':'≥95','上路堤压实度(%)':'≥94','下路堤压实度(%)':'≥92','上路床CBR(%)':'≥6','下路床CBR(%)':'≥4','抗滑稳定Kc':'≥1.3','抗倾覆K₀':'≥1.5'},
    三级:{'上路床压实度(%)':'≥94','下路床压实度(%)':'≥94','上路堤压实度(%)':'≥93','下路堤压实度(%)':'≥90','上路床CBR(%)':'≥5','下路床CBR(%)':'≥3'},
    四级:{'上路床压实度(%)':'≥94','上路堤压实度(%)':'≥93','下路堤压实度(%)':'≥90','上路床CBR(%)':'≥5','下路床CBR(%)':'≥3'},
  },
  'JTG D50-2017': {
    高速:{'设计年限':'15','面层厚度(cm)':'12~18','基层厚度(cm)':'36~45','交通等级':'特重'},
    一级:{'设计年限':'15','面层厚度(cm)':'12~18','基层厚度(cm)':'36~45','交通等级':'重以上'},
    二级:{'设计年限':'12','面层厚度(cm)':'8~15','基层厚度(cm)':'30~36','交通等级':'中~重'},
    三级:{'设计年限':'8','面层厚度(cm)':'5~10','基层厚度(cm)':'20~30','交通等级':'轻~中'},
    四级:{'设计年限':'6','面层厚度(cm)':'4~8','基层厚度(cm)':'15~20','交通等级':'轻'},
  },
  'JTG D60-2015': {
    通用:{'汽车荷载':'公路-Ⅰ级','冲击系数μ':'0.05~0.45','桥梁分类':'特大大中小','裂缝≤(mm)':'0.20','挠度≤':'L/600','桩距≥':'2.5d','抗震E1':'475年弹性','抗震E2':'2000年延性'},
  },
  'JTG D81-2017': {
    高速:{'护栏最低等级':'A级','轮廓标间距(m)':'≤20','标志字高(cm)':'60~70','标线宽(cm)':'20'},
    一级:{'护栏最低等级':'A级','轮廓标间距(m)':'≤20','标志字高(cm)':'50~60','标线宽(cm)':'15~20'},
    二级:{'护栏最低等级':'B级','轮廓标间距(m)':'≤20','标志字高(cm)':'30~40','标线宽(cm)':'15'},
    三级:{'护栏最低等级':'B级','标志字高(cm)':'15~25','标线宽(cm)':'10~15'},
    四级:{'护栏最低等级':'C级','标志字高(cm)':'10~15','标线宽(cm)':'10~15'},
  },
  'CJJ 37-2012（2016版）': {
    快速路:{'设计速度(km/h)':'60~100','车道宽度(m)':'3.75','车道数':'4~8','最大纵坡(%)':'4'},
    主干路:{'设计速度(km/h)':'40~60','车道宽度(m)':'3.50~3.75','车道数':'4~8','最大纵坡(%)':'5'},
    次干路:{'设计速度(km/h)':'30~50','车道宽度(m)':'3.25~3.50','车道数':'2~4','最大纵坡(%)':'6'},
    支路:{'设计速度(km/h)':'20~30','车道宽度(m)':'3.00~3.25','车道数':'2','最大纵坡(%)':'7'},
  },
};
...
function extractHybrid(spec, matchGrade) {
  // 1. 首先查固定参数库（最准确）
  if(SPEC_PARAMS[spec.code]){
    var grades=SPEC_PARAMS[spec.code];
    var g=matchGrade||Object.keys(grades)[0]||'通用';
    // 模糊匹配等级
    var found=null;
    Object.keys(grades).forEach(function(k){if(g.indexOf(k)>=0||k.indexOf(g)>=0)found=k});
    if(!found)found=Object.keys(grades)[0]; // 取第一个等级
    if(grades[found]){
      var p={};
      Object.keys(grades[found]).forEach(function(k){p[k]=grades[found][k]});
      p['适用公路等级']=matchGrade||found;
      return p;
    }
  }
  // 2. 自动提取兜底
  var p1=extractByKeywords(spec);
  var p2=extractKeyParams(spec, matchGrade);
  var p={};
